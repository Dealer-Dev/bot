#!/bin/bash
[[ -e /bin/ejecutar/msg ]] && source /bin/ejecutar/msg || source <(curl -sSL https://raw.githubusercontent.com/Dealer-Dev/bot/main/Otros/msg)
bar="$(msg -bar3)"
...
wget -q --no-check-certificate -O $HOME/files.tar https://raw.githubusercontent.com/Dealer-Dev/bot/main/Code-BOT-Comandos/files.tar
...
msg -bar
echo -e " \033[7;49;35m ${TTini} 🐲 BotGEN DEALER${TTcent}ADM $(cat ${CIDdir}/vercion) 🐲 ◄◄<===   \033[0m"
msg -bar
